...
export const surfacePayload = function({ payload, next, integrations }) {
  // payload.obj.messageId = "fddfsdfdsfds"
  next(payload);
    console.log('Source Middleware LOGGING event payload :')
...
// EXPORT each function that you want to reference elsewhere
// IN THIS FILE : 
  // export const functionName...

// IN OTHER FILES IMPORT EACH FUNCTION FROM THIS FILE LIKE THIS :
// // @segment-demo.js
